...
const makeAccessTokenRepository = () => {
...
const makeAccessTokenRepositoryWithError = () => {
  class UpdateAccessTokenRepositorySpy {
    async update () {
      throw new Error()
    }
...
const makeSut = () => {
  ...
  const updateAccessTokenRepositorySpy = makeAccessTokenRepository()
...
describe('Auth UseCase', () => {
  ...
  test('Should return and accessToken if correct credentials are provided', async () => {
  ...
  test('Should throw if any dependency throws', () => {
    ...
    const suts = [].concat(
      ...
      new AuthUseCase({
        ...
        encrypter,
        tokenGenerator,
        updateAccessTokenRepository: makeAccessTokenRepositoryWithError()
      })
    )
    for (const sut of suts) {
      const promise = sut.auth('any_email@mail.com', 'any_password')
